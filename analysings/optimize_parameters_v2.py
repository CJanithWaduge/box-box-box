...
print("=== PARAMETER OPTIMIZER V2 – Improved ===")
...
races = all_races[:1000]  # Use 1000 races – more data = better fit
...
# Tighter bounds around your current best
bounds = [
    (-2.6, -2.3),   # SOFT offset
    (1.8, 2.2),     # HARD offset
    (0.17, 0.20),   # SOFT deg
    (0.06, 0.08),   # MEDIUM deg
    (0.03, 0.05),   # HARD deg
    (0.0005, 0.003) # temp coeff
]

print("Starting improved optimization (10–25 minutes)...")
result = differential_evolution(
    loss,
    bounds,
    workers=1,
    popsize=20,       # more population
